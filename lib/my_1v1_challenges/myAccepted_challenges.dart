...
class MyAcceptedChallenges extends StatefulWidget {
  ...
  @override
  State<MyAcceptedChallenges> createState() => _MyAcceptedChallengesState();
}

class _MyAcceptedChallengesState extends State<MyAcceptedChallenges> {
